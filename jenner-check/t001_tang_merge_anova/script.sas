/* Adapted from tang.sas: the beverage-purchase and money datalines are
   the author's; the external .txt infile / tangdr library were dropped so
   the merge/sort/print/univariate/ANOVA run against the inline data. */

/* beverage purchases (author's datalines) */
data tang_beverage;
...
/* money spent (author's datalines) */
data tang_money;
